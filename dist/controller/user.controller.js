...
class UserController {
    ...
    initializeRoutes() {
        ...
        this.router.post(`${this.path}/`, (0, validate_middleware_1.validate)(user_validations_1.createUser), this.createUser);
        this.router.patch(`${this.path}/:id`, (0, validate_middleware_1.validate)(user_validations_1.updateUser), this.updateUser);
